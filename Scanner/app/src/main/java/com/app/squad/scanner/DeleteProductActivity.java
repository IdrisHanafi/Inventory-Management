...
public class DeleteProductActivity  extends AsyncTask<String, Void, Boolean>  {
    ...
    public DeleteProductActivity(Context context) {
    ...
    protected Boolean doInBackground(String... arg0) {
        ...
        try{
            ...
            String link="http://192.168.1.10/DeleteProduct.php";  //This is the IP/Domain name of the server with the PHP
    ...
    protected void onPostExecute(Boolean result){
        ...
        if(result) {
            ...
            new AlertDialog.Builder(context)
                    .setTitle("Uh Oh")
                    .setMessage("There was an Error, Product cannot be deleted!")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                        }
